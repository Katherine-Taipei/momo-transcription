...
namespace Momo.App
{
    ...
    public class AppSettings
    {
        ...
        public string Language { get; set; } = CultureInfo.CurrentUICulture.Name.StartsWith("zh", StringComparison.OrdinalIgnoreCase) ? "zh-TW" : "en-US";

        [JsonPropertyName("UpdateFrequency")]
        public UpdateFrequency UpdateFrequency { get; set; } = UpdateFrequency.Off;

        [JsonPropertyName("UpdateCheckSuppressUntil")]
        public DateTimeOffset UpdateCheckSuppressUntil { get; set; } = DateTimeOffset.MinValue;

        [JsonPropertyName("NextUpdatePromptAt")]
        public DateTimeOffset NextUpdatePromptAt { get; set; } = DateTimeOffset.MinValue;

        [JsonPropertyName("TelemetryPromptedCount")]
        public int TelemetryPromptedCount { get; set; }

        [JsonPropertyName("LastTelemetryPromptDate")]
        public DateTimeOffset LastTelemetryPromptDate { get; set; } = DateTimeOffset.MinValue;
    }
